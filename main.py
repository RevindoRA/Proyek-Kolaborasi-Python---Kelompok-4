...
class MultiApp(tk.Tk):
    ...
    def create_tabs(self):
        ...
        self.speed_tab = ttk.Frame(notebook)
        ...
        notebook.add(self.temp_tab, text="Suhu")
        notebook.add(self.speed_tab, text="Kecepatan")
